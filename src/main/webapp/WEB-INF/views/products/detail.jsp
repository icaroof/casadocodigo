  ...
  <header id="layout-header">
		<div class="clearfix container">
			...
			<div id="header-content">
				<nav id="main-nav">
					<ul class="clearfix">
						<li><a href="/cart" rel="nofollow">Cart (${shoppingCart.amount })</a></li>
					</ul>
				</nav>
			</div>
		</div>
		...
		<form action='<c:url value="/cart/add" />' method="post" class="container">
			...
			<ul id="variants" class="clearfix">
				<c:forEach items="${product.prices}" var="price">
					<li class="buy-option">
						<input type="radio" name="priceType" class="variant-radio" id="priceType_${price.type}" value="${price.type}"  checked="checked"  />
			...
			<button type="submit" class="submit-image icon-basket-alt" alt="Compre Agora" title="Buy now ${product.title}!"></button>
		</form>
	</section>
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <p></p>
	    <p>Data de publicação: <fmt:formatDate value="${product.publishDate.time}"/> </p>
